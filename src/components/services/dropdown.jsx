...
export default function Dropdown({ options, value, setValue, actionsText = "Select" }) {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      <div>
        <Menu.Button className="text-xs inline-flex w-full items-center rounded-sm bg-theme-200/50 dark:bg-theme-900/20 px-3 py-1.5" style={{ pointerEvents: 'auto', zIndex: 10 }}>
          {displayLabel}
      ...
      >
        <Menu.Items className="absolute right-0 z-60 mt-2 w-56 origin-top-right rounded-md bg-theme-200/50 dark:bg-theme-900/50 backdrop-blur-sm shadow-md focus:outline-hidden text-theme-700 dark:text-theme-200">
          <div className="py-1">
            {options.map((option) => (
